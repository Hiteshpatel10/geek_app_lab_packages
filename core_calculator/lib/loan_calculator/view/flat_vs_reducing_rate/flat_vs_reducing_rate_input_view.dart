...
class FlatVsReducingRateInputView extends StatefulWidget {
  const FlatVsReducingRateInputView({super.key});

  @override
  State<FlatVsReducingRateInputView> createState() => _FlatVsReducingRateInputViewState();
}

class _FlatVsReducingRateInputViewState extends State<FlatVsReducingRateInputView> {
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  BlocProvider.of<EmiCalculatorCubit>(context).calculateFlatVsReducing(
                  ...
                  CoreNavigator.pushNamed(CoreCalculatorRoutes.flatVsReducingResult);
                },
