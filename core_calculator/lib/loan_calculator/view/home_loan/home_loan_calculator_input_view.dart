...
class HomeLoanCalculatorInputView extends StatefulWidget {
  const HomeLoanCalculatorInputView({super.key});

  @override
  State<HomeLoanCalculatorInputView> createState() => _HomeLoanCalculatorInputViewState();
}

class _HomeLoanCalculatorInputViewState extends State<HomeLoanCalculatorInputView> {
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: getInterestRateSelector(
                    context,
                    interestRateList: homeLoanInterestRate,
                    onRateSelect: (rate) {
